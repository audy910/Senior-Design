...
#ifndef ROVER_PROJECT__MSG__DETAIL__WAYPOINT_LIST__FUNCTIONS_H_
#define ROVER_PROJECT__MSG__DETAIL__WAYPOINT_LIST__FUNCTIONS_H_
 ...
 * calls
 * rover_project__msg__WaypointList__init().
...
/**
 * It calls
 * rover_project__msg__WaypointList__fini()
 ...
 * rover_project__msg__WaypointList__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * rover_project__msg__WaypointList__Sequence__fini()
 * on the array,
...
#endif  // ROVER_PROJECT__MSG__DETAIL__WAYPOINT_LIST__FUNCTIONS_H_
