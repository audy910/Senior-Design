...
#include "rover_project/msg/detail/waypoint_list__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: latitudes
  {
    cdr << ros_message.latitudes;
  }
  // Member: longitudes
  {
    cdr << ros_message.longitudes;
  }
  ...
  size_t current_alignment)
{
  ...
  // Member: latitudes
  {
    ...
    size_t item_size = sizeof(ros_message.latitudes[0]);
  ...
  // Member: longitudes
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    size_t item_size = sizeof(ros_message.longitudes[0]);
    current_alignment += array_size * item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // Member: total_waypoints
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = rover_project::msg::WaypointList;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const rover_project::msg::WaypointList *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<rover_project::msg::WaypointList *>(
    untyped_ros_message);
...
{
  return &rover_project::msg::typesupport_fastrtps_cpp::_WaypointList__handle;
}
