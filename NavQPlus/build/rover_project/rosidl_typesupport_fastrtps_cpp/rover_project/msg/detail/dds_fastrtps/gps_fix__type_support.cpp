...
#include "rover_project/msg/detail/gps_fix__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const rover_project::msg::GpsFix & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  rover_project::msg::GpsFix & ros_message)
{
  // Member: latitude
  cdr >> ros_message.latitude;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = rover_project::msg::GpsFix;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const rover_project::msg::GpsFix *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<rover_project::msg::GpsFix *>(
    untyped_ros_message);
...
{
  return &rover_project::msg::typesupport_fastrtps_cpp::_GpsFix__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rover_project, msg, GpsFix)() {
  return &rover_project::msg::typesupport_fastrtps_cpp::_GpsFix__handle;
}
