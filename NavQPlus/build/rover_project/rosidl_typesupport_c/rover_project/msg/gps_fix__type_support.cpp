...
static const _GpsFix_type_support_symbol_names_t _GpsFix_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rover_project, msg, GpsFix)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rover_project, msg, GpsFix)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, rover_project, msg, GpsFix)() {
  return &::rover_project::msg::rosidl_typesupport_c::GpsFix_message_type_support_handle;
}
