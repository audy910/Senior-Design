...
static const _GpsFix_type_support_symbol_names_t _GpsFix_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rover_project, msg, GpsFix)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, rover_project, msg, GpsFix)),
  }
};
...
get_message_type_support_handle<rover_project::msg::GpsFix>()
{
  return &::rover_project::msg::rosidl_typesupport_cpp::GpsFix_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, rover_project, msg, GpsFix)() {
  return get_message_type_support_handle<rover_project::msg::GpsFix>();
}
